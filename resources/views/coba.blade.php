                                ...
                                <div class=" alert alert-info">
                                    <div class="row">
                                        <div class="col-xs-8 col-xs-offset-1">
                                            <strong>Hai {{ ucfirst(Auth::user()->name) }} </strong> Selamat datang dihalaman admin!
                                        </div>
                                        <div class="col-xs-3">
                                            <a href="{{ url('/event/create') }}" class="btn btn-green pull-right">Tambah DI</a>
                                        </div>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="panel-white">
                                            <div class="panel-heading">
                                                <h4 class="panel-title"><span class="text-bold">Event</span> Lists</h4>
