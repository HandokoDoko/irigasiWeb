            ...
            <footer class="footer footer-color-black">
                <div class="container">
                    ...
                    <div class="social-area pull-right">
                        <a class="btn btn-social btn-facebook btn-simple" href="https://www.facebook.com/diSerdang_Bedagai">
                            <i class="fa fa-facebook-square"></i>
                        </a>
                        <a class="btn btn-social btn-twitter btn-simple" href="https://twitter.com/diSerdang_Bedagai">
                            <i class="fa fa-twitter"></i>
                        </a>
                        <a class="btn btn-social btn-pinterest btn-simple" href="https://plus.google.com/+diSerdang_Bedagai">
                            <i class="fa fa-google-plus-square"></i>
                        </a>
                        <a class="btn btn-social btn-pinterest btn-simple" href="https://dribbble.com/diSerdang_Bedagai">
                            <i class="fa fa-dribbble"></i>
                        </a>
                    </div>
                    <div class="copyright">
                        &copy; 2016 <a target="_blank" href="http://www.certivy-tim.com/?ref=presentation-page"> di Serdang Bedagai</a>
                    </div>
                </div>
            </footer>
